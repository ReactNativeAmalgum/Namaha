                ...
                return (
                    <ScrollView style={{flex:1, backgroundColor:'white', }}>
                        ...
                        <View style={{width:'100%', height:110, flexDirection:'row',justifyContent:'space-between',alignItems:'center',backgroundColor:'white'}}> 
                            ...
                            <View style={{justifyContent:"center",alignContent:"center",width:97,height:97,backgroundColor:'#99FFFF', borderRadius:55,margin:10}}>
                            <Image source={{uri:this.props.user?.photo}} style={{width:90,marginLeft:3.7,backgroundColor:'#CFF6FF',height:90, borderRadius:45,}}/>
                            </View>
                            </TouchableOpacity>
